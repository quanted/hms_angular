...
export class MiniMapService {
    ...
    setupLayers() {
        ...
        this.hms.getCatchmentInfo(this.simData.network.pour_point_comid).subscribe((data) => {
            if (data.metadata) {
    ...
    createSimLayer(segmentData, style): any {
        if (segmentData.comid == this.comid) style.color = this.layerService.selectedColor;
